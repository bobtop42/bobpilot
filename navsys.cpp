...
void KALMAN::pPred(long int dt)
{
  ...
  loadv[0] = P[0][3]; loadv[1] = P[0][4]; loadv[2] = P[0][5]; loadv[3] = P[1][3];
  v2 = vld1q_f32(loadv); // v2 = p4
  ...
  loadv[0] = P[3][0]; loadv[1] = P[3][1]; loadv[2] = P[3][2]; loadv[3] = P[4][0];
  float32x4_t v4 = vld1q_f32(loadv); // v4 = p7
  ...
  loadv[0] = P[0][0]; loadv[1] = P[0][1]; loadv[2] = P[0][2]; loadv[3] = P[1][0];
  v3 = vld1q_f32(loadv); // v3 = p1
  v3 = vaddq_f32(v3, v4); // v3 = v3 + v4
  ...
  loadv[0] = P[4][5]; loadv[1] = P[5][3]; loadv[2] = P[5][4]; loadv[3] = P[5][5];
  v2 = vld1q_f32(loadv); // v2 = p11
  v3 = vmulq_f32(v1, v2); // v3 = v2 * v1
  loadv[0] = P[1][5]; loadv[1] = P[2][3]; loadv[2] = P[2][4]; loadv[3] = P[2][5];
  v2 = vld1q_f32(loadv); // v2 = p5
  v2 = vaddq_f32(v2, v3); // v2 = v2 + v3
  ...
  v2 = vmulq_f32(v2, v1); // v2 = v2 * v1
  loadv[0] = P[4][2]; loadv[1] = P[5][0]; loadv[2] = P[5][1]; loadv[3] = P[5][2];
  v4 = vld1q_f32(loadv); // v4 = p8
  v3 = vaddq_f32(v3, v4); // v3 = v3 + v4
